...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
    ...
    public void setupWindow(int width, int height) {
        ...
        mFrame.setTitle("No,I'm not a human demo");
    ...
    // SnakeGame Loop of the game. Runs continuously
    ...
    public void gameLoop(int framerate) {
        ...
        // SnakeGame loop runs until program is closed
        timer.start();
    }
...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
    ...
    // Time-Related functions
    //-------------------------------------------------------
    protected int virtualWidth = 1920;
    protected int virtualHeight = 1080;

    // 当前窗口实际大小


    // 离屏渲染缓冲
    protected BufferedImage mBackBuffer;
    ...
    protected GraphicsDevice graphicsDevice = GraphicsEnvironment
            .getLocalGraphicsEnvironment()
            .getDefaultScreenDevice();


    // 变换栈（你原本应该已有）
    protected Stack<AffineTransform> mTransforms;
    ...
    // GameEngine Constructor
    public GameEngine() {
        mBackBuffer = new BufferedImage(virtualWidth, virtualHeight, BufferedImage.TYPE_INT_ARGB);
        mGraphics = mBackBuffer.createGraphics();
        mGraphics.setRenderingHint(RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BILINEAR);
            ...
            public void run() {
                ...
                mFrame.addComponentListener(new ComponentAdapter() {
                    ...
                    public void componentResized(ComponentEvent e) {
                        Insets insets = mFrame.getInsets();
                        mWidth = mFrame.getWidth() - insets.left - insets.right;
                        mHeight = mFrame.getHeight() - insets.top - insets.bottom;
                        updateScale();
                    }
                });
    ...
    protected void updateScale() {
        scale = Math.min((double) mWidth / virtualWidth, (double) mHeight / virtualHeight);
        offsetX = (int)((mWidth - virtualWidth * scale) / 2);
        offsetY = (int)((mHeight - virtualHeight * scale) / 2);
    }
    ...
    protected class GamePanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.drawImage(mBackBuffer, offsetX, offsetY, drawW, drawH, null);
        }
